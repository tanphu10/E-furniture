...
public class TANDUNGAdminHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(TANDUNGAdminApplicationModule).Assembly);
        });
    }
    ...
    private static void ConfigureSwaggerServices(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                    {"TANDUNG.Admin", "TANDUNG API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "TANDUNG.Admin API", Version = "v1" });
    ...
    {
        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("TANDUNG.Admin");
        if (!hostingEnvironment.IsDevelopment())
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "TANDUNG Admin API");
