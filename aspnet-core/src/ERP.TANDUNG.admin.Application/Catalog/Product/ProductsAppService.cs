...
namespace ERP.TANDUNG.Admin.Catalog.Products
{
       ...
       CreateUpdateProductDto>, IProductsAppService
    {
        ...
        public override async Task<ProductDto> UpdateAsync(Guid id, CreateUpdateProductDto input)
        {
            ...
            if (product == null)
                throw new BusinessException(TANDUNGDomainErrorCodes.ProductIsNotExists);
        ...
        public async Task<ProductAttributeValueDto> AddProductAttributeAsync(AddUpdateProductAttributeDto input)
        {
            ...
            if (attribute == null)
                throw new BusinessException(TANDUNGDomainErrorCodes.ProductAttributeIdIsNotExists);
            ...
            switch (attribute.DataType)
            {
                case AttributeType.Date:
                    ...
                    {
                        throw new BusinessException(TANDUNGDomainErrorCodes.ProductAttributeValueIsNotValid);
                    }
